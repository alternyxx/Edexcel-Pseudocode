...
class Translation():
    ...
    def compile(self):
        ...
        for line in self.pseudocode:
            ...
            # File handling
            elif read := fullmatch(rf"READ({end_of_line})", result_line):
                ...

            elif write := fullmatch(rf"WRITE({end_of_line})", result_line):
                ...
            ...
            # Subprograms
                ...
                print(result_line)
                print(f'Syntax Error at result_line {self.pseudocode.index(line) + 1}')
                exit()
            print(result_line)
